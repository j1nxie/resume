...
#let info = author => align(center)[
  ...
  #author.home · #author.github · #author.linkedin
]
...
#let project(title: "", author: (name: ""), body) = {
  ...
  set page(numbering: "1 / 1", number-align: center, margin: (x: 0.7in, y: 0.5in))
  set text(font: serif, lang: "en")
  ...
  // Author information.
  pad(top: 0.5em, bottom: 0.5em, x: 2em, info(author))
...
#let titleemj(name, baseline: 1.5pt) = {
  box(baseline: baseline, height: 16pt, image(name))
}
